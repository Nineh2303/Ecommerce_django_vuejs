            ...
            <div class="column is-12 box">
                ...
                <div class="columns is-multilne">
                    ...
                    <div class="column is-6"> 
                        ...
                        <div clas="field">
                            <label> ZipCode<strong style="color:red">*</strong></label>
                            <div class="control">
                                <input type="text" class="input" v-model="zipcode">
                            </div>
                        </div>
                        <div clas="field">
                            <label>Place<strong style="color:red">*</strong></label>
                            <div class="control">
...
export default {
    ...
    mounted() {
        ...
        if(this.cartTotalLength > 0) {
            this.stripe = Stripe('pk_test_51IzN5FBE7MCF29mgI6oaJq8joNPAy8IWbDOgVSHOHgjXFD5DdNELwQoIlOrVoSVsi6e8cVowNgWvJP7PPxKJ1tY200yyd6FetQ')
